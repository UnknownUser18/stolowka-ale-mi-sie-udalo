...
export class VariablesService {
  ...
  // TODO: Reimplement entire service when backend is implemented
  ...
  //  * @param force{boolean} - Jeśli `true`, wymusza ponowne pobranie danych z serwera.
  ...
  //  */
  // public async mapStudentsToOpiekun(force : boolean = false) : Promise<(Student & Opiekun)[]> {
  //   if (!this.persons_zsti || !this.opiekun_zsti || force)
