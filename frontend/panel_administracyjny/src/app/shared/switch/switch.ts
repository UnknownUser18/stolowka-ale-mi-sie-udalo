...
import { TooltipAuxClickTriggerDirective } from '@directives/auxTooltip/tooltip-aux-click-trigger.directive';
...
export class Switch implements FormValueControl<State> {
  ...
  protected tooltipChange = viewChild.required<Tooltip>('tooltipChange');
